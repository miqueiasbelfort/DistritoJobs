...
function JobCard() {
  ...
  function lengtText(text: string): string {
  ...
  return (
    <div className={styles.container}>
        ...
        <Link className={styles.informationsContainer} to={"/job"}>
            ...
            <p>{lengtText("Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil sapiente tenetur, sint eius quidem doloremque mollitia dolorem maxime inventore provident deserunt reiciendis ex dignissimos cumque ratione ipsam recusandae aspernatur at?")}</p>
        </Link>
    </div>
  )
}
